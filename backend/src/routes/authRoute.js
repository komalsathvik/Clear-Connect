...
router.put("/update-profile", userVerification, upload.single("profilePic"), async (req, res) => {
  try {
...
router.get("/auth/google/callback",
    ...
    (req,res)=>{
        ...
        res.redirect(`http://localhost:5173/google-auth-success?token=${token}&name=${username}&email=${email}&picture=${encodeURIComponent(picture)}`);
    }
)
